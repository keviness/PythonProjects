...
class RequestApi(object):
    ...
    def prepare_request(self):
        return self.gene_request(apiname=api_prepare, data=self.gene_params(api_prepare))
    ...
    def upload_request(self, taskid, upload_file_path):
        ...
        try:
            ...
            while True:
                ...
                data = self.gene_params(api_upload, taskid=taskid, slice_id=sig.getNextSliceId())

                response = self.gene_request(api_upload, data = data, files=files)
    ...
    def get_result_request(self, taskid):
        response = self.gene_request(api_get_result, data=self.gene_params(api_get_result, taskid=taskid))
...
if __name__ == '__main__':
    api = RequestApi(appid="5f368b48", secret_key="d60ab1681c013a265ee6858bef330d97", upload_file_path=r"cold.wav")
    api.all_api_request()
